...
import * as Plugin_0 from 'D:/ce/full-stack-monorepo/apps/liberty-ui/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/ce/full-stack-monorepo/apps/liberty-ui/src/app.tsx',
    },
    {
      apply: Plugin_1,
